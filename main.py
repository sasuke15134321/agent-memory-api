...
@app.post(
    ...
    description="Primary memory storage endpoint. Stores AI agent memory with AES-256 encryption. Use to persist memory across sessions. Includes SHA256 deletion audit proof.",
    tags=["Memory"],
...
@app.post(
    ...
    description="Recalls stored AI agent memory by semantic query. Use before agent reasoning, paid actions, or external tool use. Returns encrypted memory with audit trail.",
    tags=["Memory"],
    responses={402: {"description": "Payment Required"}},
...
@app.get(
    ...
    description="Returns audit log of all memory operations. Use GET method. Do not POST to this endpoint. Includes store, recall, and delete events with timestamps.",
    tags=["Memory"],
    responses={402: {"description": "Payment Required"}},
    openapi_extra=paid_operation("0.05"),
)
